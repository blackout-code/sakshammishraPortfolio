...
function XSvg({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const socialSvgs: Record<string, React.ComponentType<{ size?: number }>> = {
  github: GithubSvg,
...
export function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative section-spacing">
      {/* Background gradient connector */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-primary/[0.02] to-background pointer-events-none" />
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 max-w-xl mx-auto text-text-secondary text-base">
            Interested in backend engineering, enterprise architecture, or AI-enabled systems? 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          >
            <div className="glass-card-bordered rounded-2xl p-7 space-y-6">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-primary/[0.08] text-primary flex-shrink-0">
                  <Mail size={18} />
                </div>
                <div>
                  ...
                  <a
                    ...
                    className="text-sm text-text-secondary hover:text-primary transition-colors mt-1 block"
                  >
                    {personalInfo.email}
                  </a>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary mt-1">{personalInfo.location}</p>
                </div>
              </div>
          ...
          >
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-7 sm:p-8 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="relative">
                  <label
                    htmlFor="name"
                    className="text-[11px] font-semibold text-text-secondary mb-2 block uppercase tracking-wider"
                  >
                    Name
                  </label>
                  <input
