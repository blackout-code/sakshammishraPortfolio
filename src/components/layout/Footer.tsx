          ...
          <div className="w-full pt-8 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                type="button"
                onClick={scrollToTop}
                className="group p-2 rounded-lg text-text-quaternary hover:text-text-primary hover:bg-white/[0.04] transition-colors duration-200 border border-white/[0.04] hover:border-white/[0.08]"
